    ...
    public void progress() {
        ...
        if (!isLaunched) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                Particles.spawnParticle(GeneralMethods.getMCVersion() >= 1205 ? Particle.valueOf("FISHING") : Particle.WATER_WAKE, origin.clone().add(rv2), 0, -rv.getX(), 0, -rv.getZ(), 0.2);
                ...
                Particles.spawnParticle(GeneralMethods.getMCVersion() >= 1205 ? Particle.valueOf("BUBBLE") : Particle.WATER_BUBBLE, origin.clone().subtract(0, 1, 0).add(rv), 0, rv.getX(), 0, rv.getZ(), 0.3);
            }
        }
        else {
